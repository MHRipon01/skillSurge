    ...
    return (
        ...
        <div className="">
          ...
          <div className="text-center hidden md:block lg:text-left">
            ...
            <div className=" justify-center text-center mx3 items-center  w-full select-none rounded-lg bg-gradient-to-tr from-blue-500 to-[#92e1f6]  align-middle font-sans text-xs font-bold uppercase text-black shadow-md   transition-all hover:shadow-lg mt-8 hover:shadow-[#92e1f6]  flex">
